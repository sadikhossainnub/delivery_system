...
#
# RedX Courier API client — STUB (not yet implemented)
# Implement this module when RedX integration is needed.
...
class Client(BaseCourierClient):
	...
	def create_order(self, order_data: dict) -> dict:
		frappe.throw(frappe._("RedX courier integration is not yet implemented."), frappe.ValidationError)
